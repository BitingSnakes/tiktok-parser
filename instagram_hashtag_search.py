...
from instagram_reels_search import INSTAGRAM_USER_AGENT, InstagramReelsSpider


DEFAULT_INPUT = "data/instagram_reels.jl"
DEFAULT_OUTPUT = "data/instagram_hashtag_reels.jl"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Read JSONL output, extract hashtags, and search Instagram Reels "
    ...
    parser.add_argument(
        ...
        type=int,
        default=25,
        help="Maximum discovered Reels to follow from each hashtag search. Defaults to 25.",
    )
    parser.add_argument(
        "--concurrency",
        type=int,
...
def main() -> None:
    ...
    run_spider(
        ...
        queries=queries,
        max_reels_per_query=args.max_reels_per_tag,
        request_middlewares=[
